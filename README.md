...
<p> 
    ...
    Two <code>PointNet</code> deep-learning models were adopted for image pre-process procesure.
...
<p>
    <ul>
        ...
        <li>Model and other parameters adjustment can be done under <code>Settings</code>.</li>
